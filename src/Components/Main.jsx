...
const Main = () => {
    ...
    const{onSent,resultData,showResult,setInput,input,loading,extended, setExtented, recentPrompt}= useContext(Context)
             ...
             <div className='flex-1 overflow-y-auto max-h-[calc(100vh-30vh)] hide-scrollbar'>
                ...
                <div className='md:px-32 flex-col px-5 py-10 flex gap-7'>
                        <div className='flex md:pr-20 gap-3 justify-end '>  
                            ...
                            <p className={` p-[11px] text-sm  rounded-full`}><FaRegUser /></p>
                        </div>
                                     {loading ?(
